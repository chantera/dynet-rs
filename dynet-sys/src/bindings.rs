...
pub struct CExpression {
    pub cg: *mut ::std::os::raw::c_void,
    pub v_index: ::std::os::raw::c_uint,
    pub graph_id: ::std::os::raw::c_uint,
}
#[test]
fn bindgen_test_layout_CExpression() {
    assert_eq!(::std::mem::size_of::<CExpression>() , 16usize , concat ! (
               "Size of: " , stringify ! ( CExpression ) ));
    assert_eq! (::std::mem::align_of::<CExpression>() , 8usize , concat ! (
                "Alignment of " , stringify ! ( CExpression ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const CExpression ) ) . cg as * const _ as
                usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( CExpression ) , "::" ,
                stringify ! ( cg ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const CExpression ) ) . v_index as * const _ as
                usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! ( CExpression ) , "::" ,
                stringify ! ( v_index ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const CExpression ) ) . graph_id as * const _
...
extern "C" {
    pub fn C_as_vector(v: *const CTensor) -> *mut f32;
}
extern "C" {
...
extern "C" {
    pub fn CParameter_dim(p: *mut CParameter) -> *mut CDim;
}
extern "C" {
